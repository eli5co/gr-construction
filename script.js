...
class MobileMenu {
    constructor() {
        this.menuBtn = querySelector('#mobileMenuBtn');
        this.nav = querySelector('#navLinks');
        this.overlay = querySelector('#menuOverlay');
        this.isOpen = false;
...
class ServiceTabs {
    constructor() {
        this.tabs = querySelectorAll('.category-tab');
        this.contents = querySelectorAll('.service-category-content');
...
class ScrollAnimator {
    constructor() {
        this.elements = querySelectorAll('.fade-in-section');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    querySelectorAll('.before-after').forEach(slider => new BeforeAfterSlider(slider));
    ...
    const yearElement = querySelector('#currentYear');
    if (yearElement) {
...
document.addEventListener('visibilitychange', () => {
    const testimonials = querySelector('.testimonials-slider');
    if (testimonials) {
        if (document.hidden) {
            testimonials.pause?.();
        } else {
